...
const questionData = {
  ...
  sections: {
    one: [
      ...
      {
        heading: 'While you explore, this map will help put names to some of the life that you see. Look for the beautiful images, names, and interesting facts about these plants and animals.',
        items: [],
      },
      {
        heading: 'If you are curious to learn more, take photos of your discoveries and use iNaturalist and eBird apps on your smartphone to confirm your sightings. You will create data for scientists working to better understand and protect nature.',
        items: [],
      },
      {
        heading: 'Enjoy a journey to learn, love and discover more about nature.',
        items: [],
      },
      {
...
const Question = {
  ...
  layers: [
    { key: 'Naturehood_LearningCentres', active: true, ...LegendGroups.Naturehood },
    ...
    { key: 'Naturehood_PlaceNamesEnglish', active: true, ...LegendGroups.Naturehood },
    { key: 'Naturehood_FirstNationsReserves', active: true, ...LegendGroups.Naturehood },
  ...
  tabs: [
    ...
    },
    {
      ...
      children: [
        ...
        <Text>Nature Canada’s NatureHood Program is about connecting children and families to nature right where they live. It is a call to expose a new generation of nature lovers, naturalists and citizen scientists to nature all around them. To learn more about NatureHood visit www.gvnaturehood.com orcontact us at info@gvnaturehood.com.</Text>,
        <Text {...h3}>Greater Victoria Naturehood</Text>,
        <Text>Being in nature promotes awareness of our natural world and increases mental and physical health, as well as overall wellbeing. The Greater Victoria NatureHood aims to inspire children – and adults – to appreciate nature and take action to protect local species and natural places.</Text>,
        <Text {...h3}>Connect with Nature</Text>,
        <Text>Connect with nature by taking time to simply go outdoors and explore the natural world around you. This can be as simple as going to your backyard or to a local park. You do not have to go far to explore nature. Make your city nature-friendly by working with your community to restore city parks, ravines, open spaces and other natural places for birds and native wildlife.</Text>,
        <Text {...h3}>Leave No Trace</Text>,
        <Text>When you visit the Greater Victoria NatureHood, be sure to dispose of your waste appropriately.</Text>,
        <Text {...h3}>Respect Wildlife</Text>,
        <Text>Feeding wildlife can lead to health impacts, alter natural behaviours, and increase exposure to predators and other dangers. Do not follow or approach wildlife but instead, observe from a distance. Avoid wildlife during sensitive times such as mating, nesting, raising their young. Pets may not be permitted at the places that you visit, please visit location websites prior to heading out with your family.</Text>,
        <Text {...h3}>Get Out Into the Naturehood</Text>,
        <Text>By using this map, you can connect with nature at nearby urban protected areas, like Esquimalt Lagoon Migratory Bird Sanctuary, Shoal Harbour Migratory Bird Sanctuary and, Victoria Harbour Migratory Bird Sanctuary, to name but just a few. We hope that your experience will inspire you to care for and protect our natural environment.</Text>,
        <Text {...h3}>Connecting Greater Victoria\'s NatureHoods</Text>,
        <Text>The Greater Victoria NatureHood is a partnership of grassroots naturalist organizations, not-for-profits and local governments, all sharing a strong commitment to protect nature in the Greater Victoria Region. It promotes nature awareness through education, stewardship activities and events, and wildlife observation, in our public green spaces.</Text>,
        <Text {...h3}>Resilient Naturehood</Text>,
        <Text>A NatureHood is any place where you connect with nature’s wonders – from observing a bee pollinate a flower in a planter box, to watching wild birds at a backyard feeder or local park, to witnessing the trees change with the passing of the seasons in your local forest. Look around and you will find nature everywhere throughout the Greater Victoria NatureHood.</Text>,
        <Text {...h3}>Respect the Wildlife Laws</Text>,
        <Text>The federal Migratory Birds Convention Act protects birds, their nests, and their eggs from harm or capture in Canada. Other provincial wildlife laws protect other species in the same way. Purchasing, keeping or trading a threatened species of wildlife from other countries is also illegal without a permit.</Text>,
        <Text {...h3}>Leave What You Find</Text>,
        <Text>To help preserve the past and present for the future, examine, but do not touch, cultural or historic artifacts and structures. Leave any rocks, plants and other natural objects as you find them and avoid introducing or transporting non-native species.</Text>,
        <Text {...h3}>Be Mindful of Others</Text>,
        <Text>Be courteous. One of the most important components of outdoor ethics is to be courteous to others, and follow local regulations. Many people visit the NatureHood specifically to listen to nature, so please maintain quiet and keep yourears open.</Text>,
        <Text {...h3}>Become a Naturehood Steward</Text>,
        <Text>Build community while connecting with nature. Protect the NatureHood by joining one of the many stewardship groups in Greater Victoria who volunteer in natural areas. Opportunities include:</Text>,
        ...
        <Text>To find an opportunity that suits your interests, visit <Link isExternal href='https://www.gvnaturehood.com'>www.gvnaturehood.com</Link></Text>,
        <Text {...h3}>About the Cover Art</Text>,
        <Text>There are so many wonderful natural places to explore in the Greater Victoria NatureHood, which made it hard to choose just one to showcase on the cover. Artist Kristi Bridgeman came up with a fictional work that captures special elements from many of Victoria’s natural spaces, including the iconic Garry Oak habitat, which supports many species at risk. With less than 5% of the original Garry Oak habitat remaining in British Columbia, it was important to include this ecosystem as well as a variety of native flora and fauna including the Purple Martin, Bumblebee and camas flowers.</Text>,
        <Text {...h2}>Acknowledgements</Text>,
        <Text>We acknowledge with respect the territory of the SENĆOŦEN and lək̓ʷəŋən speaking peoples on whose traditional lands and waterways we live, work and play and whose deep relationship to place continues to this day. Greater Victoria NatureHood looks forward to building a future map that includes more First Nations knowledge, language and history to provide a more complete illustration of our region’s natural heritage.</Text>,
      ]
    },
    {
      ...
      subtitle: (<>Use this handy checklist to track the Locals you have seen in the NatureHood. Artwork by <Link isExternal href='https://www.kristibridgeman.com/'>Kristi Bridgeman</Link>.</>),
      ...
      children: [
        (<Text
          ...
          fontWeight='500'
          fontSize='0.75rem'
        ><LuInfo style={{display: 'inline'}}/> Data is kept on your device, cannot be transfered to another device, and is never sent to the cloud, RUSH, or anyone.</Text>),
        (<Box
          margin='0.25rem'
          padding='0.25rem'
          bgColor='#eef4d6'
    ...
    },
    {
      ...
      children: [
        <Text>Greater Victoria is high in biodiversity, as shown by the great variety of plants, animals, and ecosystems that are found throughout the region. Biodiversity can be observed close to home, in backyard gardens, grassy parks, and street trees. Biodiversity is even higher in our region’s natural ecosystems, including:</Text>,
        ...
        <Text>• Vancouver Island is a biodiversity hotspot and is thought to have provided refuge to plants and animals during the last glaciation.</Text>,
        <Text>• Victoria sits in the Coastal Douglas-fir Biogeoclimatic zone – an area affected by factors like temperature, rainfall, moisture balance and altitude – which covers only 0.3% of the province but is home to the highest number of species and ecosystems at risk in BC.</Text>,
        <Text>• Some species like the Vancouver Island Water Shrew (found near Sooke) are endemic to Vancouver Island, meaning they are not found anywhere else.</Text>,
        <Text>As you visit different sites in the NatureHood, watch and listen for the incredible biodiversity that surrounds you.</Text>,
        <Text {...h2}>Waterways and Watersheds</Text>,
        <Text>We all live in a watershed, whether natural, urban or rural. A watershed is an area of land that drains precipitation and groundwater to a common point, such as a creek, wetland, lake or ocean. Healthy watersheds feature ample trees and abundant vegetation that help to slow, clean, and store water by allowing it to absorb into the landscape. Watersheds can be different sizes and scales, and small watersheds can be part of larger watersheds. Each watershed plays an important role in maintaining our water cycle while providing important habitat to local plants and animals. Do your part and learn how you can clean, protect and enhance the watersheds in your NatureHood.</Text>,
