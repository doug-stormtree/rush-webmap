...
const Question = {
  ...
  title: "Be Healthy",
  question:
    "Personal and planetary health are the same thing. How can I keep my natural life support system connected and protected?",
  ...
  layers: [
    { key: "GreenspaceForAll-RestrictedGreenspace", active: true, ...LegendGroups.G4A },
    { key: "GreenspaceForAll-UnderservedCommunity", active: true, ...LegendGroups.G4A },
    { key: "BigTrees", active: true, ...LegendGroups.Trees },
    { key: "CentennialSquareTree", active: true, ...LegendGroups.Trees },
    { key: "CarbonSequestration", active: false, ...LegendGroups.Landcover },
    { key: "CherryTrees", active: false, ...LegendGroups.Trees },
    { key: "CommunityMaps", active: false, ...LegendGroups.Community },
    { key: "ENBS", active: true, ...LegendGroups.Community },
    { key: "GreenBlueBelt", active: false, ...LegendGroups.Landcover },
    { key: "MaltbyLakeBirdsong", active: false, ...LegendGroups.Landcover },
    { key: "Pollinators", active: false, ...LegendGroups.OGM },
    { key: "SensitiveEcosystems", active: false, ...LegendGroups.Landcover },
    { key: "SpeciesAtRisk", active: false, ...LegendGroups.Landcover },
    { key: "StewardshipGroups", active: false, ...LegendGroups.Community },
    { key: "TreeBylaws", active: false, ...LegendGroups.Trees },
    { key: "TreeCoverage2005", active: false, ...LegendGroups.Trees },
    { key: "TreeCoverage2019", active: false, ...LegendGroups.Trees },
    { key: "TreeEquity", active: false, ...LegendGroups.OGM },
    { key: "Watersheds", active: false, ...LegendGroups.Landcover },
    {
  ...
  act: {
    initiatives: [
      ...
      },
      {
        ...
        description:
          "This Tactical Guide to help you re-imagine, re-think and re-purpose the spaces in your neighbourhood to support and encourage physical activity and social connections is funded by the federal public health agency and created by Canada Parks and Recreation.",
      ...
      },
      {
        ...
        description:
          "The mission of QCHCA is to be an advocate and trusted resource for sustainability, vibrancy and engagement in our community. Through its Climate Action initiative, the community is undertaking pollinator mapping, urban food farming and tree canopy initiatives and an annual going-greener event.",
        tags: [Tag.Organization],
      },
      {
        ...
        description:
          '"The Gorge Tillicum Community Association is a volunteer-based non-profit organization that seeks to further the collective interests of the Gorge Tillicum neighbourhood.  The GTCA is recognized by Saanich as a significant community voice on local issues."',
        tags: [Tag.Organization],
      },
      {
        ...
        description:
          "The purpose of this StoryMap is to highlight the historical connectivity between culture, community, and ecology on the Saanich Peninsula, and look for ways to improve connectivity in future collaboration with the Saanich Peninsula Environmental Coalition (SPEC).  This map was created by Ella Bethune, Darryl Seah, Ben DesRosiers, Ardis Mellor-Laing, as part of their work with the University of Victoria, Saanich Peninsula Environmental Coalition, and the Engage with Nature-based Solutions Initiative.",
        tags: [Tag.StoryMap],
      },
      {
        ...
        description:
          "Use this digital map to help you navigate natural places in Greater Victoria. Learn about the Greater Victoria NatureHood initiative, ecosystems and biodiversity, waterways and watersheds, riparian zones, and some of the species of plants and animals found in the region.",
        tags: [Tag.Map],
      },
      /*
      {
      ...
      */
      ...
      },
      {
        ...
        description:
          "The Capital Regional District has published a number of identification charts and fact sheets about the living things that can be found in our regional parks. Follow the link to learn about local mosses, seaweeds, lichens, shoreline birds and more!",
        tags: [Tag.Portal],
      },
      {
      ...
      },
      {
        ...
        description:
          "The Greater Victoria Green Team has worked since 2014 to connect people and nature for the well-being of all. There are plenty of opportunities for volunteers to get their hands dirty with the Green Team. Projects include removal of invasive plants and native planting; picking up litter from shorelines, creeks and parks; trail building and maintainence; and tending vegetable gardens on educational farms.",
        tags: [Tag.Organization],
      },
      {
      ...
      },
      {
        ...
        tags: [Tag.Report, Tag.Indigenous],
      },
      {
      ...
      },
      {
        ...
        description:
          "This 2021 report demonstrates that the healthy areas of our planet are largely because of Indigenous and local community effort.  Our success in addressing climate change depends on all governments, businesses, and organizations to honour the rights of Indigenous peoples, their connection to the land, and to learn from their way of life.",
        tags: [Tag.Report],
      },
      {
        ...
        description:
          "Drawing on lessons learned from a demonstration area in a Helsinki park, this paper highlights the importance of healthy urban vegetation and soils for carbon sequestration, as well as for stormwater management, urban recreation and food production.",
        tags: [Tag.Report],
      },
      {
      ...
      },
      {
        ...
        description:
          "VG4A is a group of over 100 Victoria grandmothers and grand others who work to raise funds and awareness to support Africa’s resilient grandmothers who have taken on the loving challenge of raising their grandchildren orphaned due to HIV & AIDS. Organizing, fundraising, awareness, and social events include sale of crafts at markets; school and community presentations; and an annual cycling tour. All proceeds from VG4A are donate to the Stephen Lewis Foundation Grandmothers to Grandmothers Campaign.",
        tags: [Tag.Organization],
      },
    ],
  },
